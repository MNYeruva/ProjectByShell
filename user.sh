...
VALIDATE $? "Downloaded user artifacts"
cd /app 
VALIDATE $? "Moving into app dir"
unzip /tmp/user.zip &>>LOGFILE
VALIDATE $? "Unzpping user"
...
#Give full path of user.service ,we are inside /app
cp /home/centos/ProjectByShell/user.service /etc/systemd/system/user.service &>>LOGFILE
...
mongo --host mongodb.mnyeruca.online </app/schema/user.js &>>LOGFILE
